...
A full-stack MERN (Mysql, Express, React, Node) application for note-taking CRUD Application. This app allows users to create, edit, delete, and search notes, with user authentication and JWT-based login.
